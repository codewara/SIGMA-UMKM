...
| owner2@sigma-umkm.com | owner123 | UMKM_OWNER | ✅ Active |
...
# Activate UMKM_OWNER #2
docker exec -it sigma-mongo mongosh -u root -p sigma --authenticationDatabase admin sigma_db --eval "db.users.updateOne({ email: 'owner2@sigma-umkm.com' }, { \$set: { account_status: 'active' } })"
