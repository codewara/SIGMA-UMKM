  ...
  return (
    <div className="space-y-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-white/70">Prediksi pendapatan UMKM di wilayah 3 bulan ke depan</p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-blue-500/30 rounded-3xl p-6 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-white/70 text-sm mt-1">Forecast ini berbasis data historis dan tren pasar terkini untuk UMKM di wilayah Anda.</p>
          </div>
        </div>
