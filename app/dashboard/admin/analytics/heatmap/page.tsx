...
export default function AdminHeatmapAnalytics() {
  const regionData = [
    { region: 'Malang', umkm: 34, growth: '+18.5%', status: 'Hot', color: 'bg-red-500' },
    { region: 'Surabaya', umkm: 28, growth: '+12.3%', status: 'Warm', color: 'bg-yellow-500' },
    { region: 'Bandung', umkm: 22, growth: '+8.7%', status: 'Warm', color: 'bg-yellow-500' },
    { region: 'Jakarta', umkm: 18, growth: '+5.2%', status: 'Cool', color: 'bg-blue-500' },
    { region: 'Medan', umkm: 12, growth: '+3.1%', status: 'Cool', color: 'bg-blue-500' },
    { region: 'Makassar', umkm: 9, growth: '+1.8%', status: 'Cold', color: 'bg-cyan-500' },
  ];
  ...
  return (
    <div className="space-y-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Heatmap Pertumbuhan Regional</h1>
          <p className="text-white/70">Visualisasi konsentrasi UMKM dan pertumbuhan per wilayah</p>
        </div>
        ...
        {/* Regional Statistics */}
        <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6">
          <h2 className="text-xl font-semibold text-white mb-4">Statistik Regional</h2>
