        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { label: 'Kota', value: umkm.wilayah.kota, icon: MapPin, color: 'from-green-400 to-emerald-500', bg: 'from-green-500/20 to-emerald-500/20' },
                { label: 'Sektor', value: umkm.sektor, icon: Award, color: 'from-blue-400 to-cyan-500', bg: 'from-blue-500/20 to-cyan-500/20' },
                { label: 'Karyawan', value: umkm.jumlah_karyawan || 'N/A', icon: Users, color: 'from-purple-400 to-pink-500', bg: 'from-purple-500/20 to-pink-500/20' },
                { label: 'Tahun Berdiri', value: umkm.tahun_berdiri || 'N/A', icon: Calendar, color: 'from-orange-400 to-red-500', bg: 'from-orange-500/20 to-red-500/20' },
              ].map((stat, idx) => (
                  ...
                  <div className="space-y-4">
                    ...
                    {umkm.pemilik?.email && (
                      <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-4 border border-white/10 hover:border-white/30 transition">
                        ...
                        <p className="text-xl font-bold text-white ml-8">{umkm.pemilik.email}</p>
                      </div>
                    )}
                  ...
                  <div className="space-y-4">
                    ...
                    {umkm.tahun_berdiri && (
                      <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-4 border border-white/10 hover:border-white/30 transition">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <p className="text-gray-300 text-sm">Tahun Berdiri</p>
                        </div>
                        <p className="text-xl font-bold text-white ml-8">{umkm.tahun_berdiri}</p>
                      </div>
                    )}
                    ...
                    {umkm.jumlah_karyawan && (
                      <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-4 border border-white/10 hover:border-white/30 transition">
                        ...
                        <p className="text-xl font-bold text-white ml-8">{umkm.jumlah_karyawan} Orang</p>
                      </div>
                    )}
                  </div>
                </div>
